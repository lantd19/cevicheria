...
class MensajesController{
	...
	#------------------------------------------------------------
	static public function mostrarMensajesController(){
	...
	static public function borrarMensajesController(){
	...
	static public function responderMensajesController(){
		...
		if(isset($_POST['enviarEmail'])){
		   ...
		   $cabeceras .= 'From: <elio18david@gmail.com>' . "\r\n";
	...
	#------------------------------------------------------------
	 static public function mensajesSinRevisarController(){
	...
	#MENSAJES REVISADOS
	#------------------------------------------------------------
	static public function mensajesRevisadosController($datos){
