...
class GestorPerfilesModel{
	...
	#GUARDAR PERFIL
	#------------------------------------------------------------
	static public function guardarPerfilModel($datosModel, $tabla){
	...
	#VISUALIZAR PERFILES
	#------------------------------------------------------
	static public function verPerfilesModel($tabla){
	...
	#ACTUALIZAR PERFIL
	#---------------------------------------------------
	static public function editarPerfilModel($datosModel, $tabla){
	...
	#BORRAR PERFIL
	#-----------------------------------------------------
	static public function borrarPerfilModel($datosModel, $tabla){
